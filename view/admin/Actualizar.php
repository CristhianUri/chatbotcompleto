...
<body class="sb-nav-fixed">
    ...
    <div id="layoutSidenav">
        ...
        <div id="layoutSidenav_content">
            ...
            $update = $bd->query("SELECT * FROM noregistrada WHERE ID_nopregunta = $id;");
                            ...
                            <div class="container">
                                <div class="d-flex justify-content-center ">
                                    ...
                                    <div class="col-lg-6 col-md-3">
                                        ...
                                        <form id="frm_nuevares" method="POST" action="../../infochat/nuevapregunta.php">
                                            <div class="mb-3 text-center">
                                                ...
                                                <input type="text" class="form-control border-dark texarea "
                                                    value="<?php echo $resultado['ID_nopregunta'] ?>" id="id" name="id"
                                                    placeholder="<?php echo $resultado['ID_nopregunta'] ?>">
                                            </div>
                                            <div class="mb-3 text-center">
                                                <label for="queries2" class="form-label">
                                                    <p class="text-break">Pregunta no resgristrada <br>
                                                        <strong>Nota:</strong>
                                                        Puedes agregar palabras o preguntas relacionada a la anterior
                                                    </p>
                                                </label>
                                                <input type="text" class="form-control border-dark texarea "
                                                    id="queries2" name="queries2"
                                                    value="<?php echo $resultado['preguntas2'] ?>"
                                                    placeholder="<?php echo $resultado['preguntas2'] ?>">
                                            </div>
                                            <div class="mb-3 text-center">
                                                <label for="response2" class="form-label">Registra la respuesta a la
                                                    pregunta</label>
                                                <textarea class="form-control border-dark texarea" id="response2"
                                                    name="response2" rows="3"
                                                    placeholder="<?php echo $resultado['respuestas2'] ?>"></textarea>
                                            </div>
                                            <div class="mb-3">
                                                <button type="submit" class="btn btn-success">Agregar al chat</button>
                                            </div>
